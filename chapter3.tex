...
analysis. In Fig. \ref{fig:FIG28_EQPATHS} we show how the results using the 
hybrid element compares with the nonlinear flexibility element in 
OpenSees\cite{OpenSees} assuming both shear participation and purely flexural 
response to inelastic deformation. Since OpenSees does not provide 
shear-flexure interraction capabilities at the level of fiber, we employed the 
