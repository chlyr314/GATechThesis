...
for this problem are listed in Table \ref{table:TABLE_CH5EX1}. 
...
plane, is shown in Fig. \ref{fig:FIG45}.
...
external load
applied with a geometric imperfection, as shown in Fig. \ref{fig:FIG46_B}. The 
...
Fig. \ref{fig:FIG46_B}, is tracked from
