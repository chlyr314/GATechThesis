...
\begin{figure*}[t]
	\centering
	\subfloat[][]{{\includegraphics[width=7.5cm]{FIG42_INTERP.pdf}}\label{FIG42_INTERP}}%
	\qquad
	\subfloat[][]{{\includegraphics[width=7.5cm]{FIG42_TANGENT.pdf}}\label{FIG42_TANGENT}}%
...
\subsection{Arc-length Stabilization of the WLS Process}\label{CH5-S2SS3}
...
\subsection{The Weight Function for the WLS Prediction Scheme}\label{CH5-S2SS4}
...
\subsection{Algorithm for the WLS Predictor}\label{CH5-S3SS1}
...
\subsection{Arc-Length Measurement of the Solution Paths}
...
\begin{table*}
	...
	\noindent\makebox[\textwidth]{
		\begin{tabular}{@ {}lccccccccccccccc@ {}}\toprule\toprule
			...
			& Nf & Nl & Ni\\
			\midrule
			Euler               & -      & 304 & 1,210 & 1,209 & 2&& - & - & - 
			&  
			- && - & - & - &  -\\
			\midrule%\addlinespace[3pt]
			\multirow{4}*{WLSE} &$(2,3)$ & 304 & 1,207 & 1,201 & 2&& - & - & - 
			& 
			- && - & - & - & -\\
			&$(2,4)$ & 304 & 1,211 & 1,207 & 2&& 49  & 323 & 451 & 30 && -   & 
			-   & -   &  -\\
			&$(2,5)$ & 304 & 1,211 & 1,207 & 2&& -  & - & - & - && -  & - & - & 
			-\\
			&$(3,5)$ & 304 & 1,142 & 1,067 & 2&& 32 & 157 & 185 & 4 && 32  & 
			156 
			& 183 &  4\\
			\midrule%\addlinespace[3pt]
			\multirow{4}*{WLST} &$(2,3)$ & 304 & 1,209 & 1,205 & 2&& -  & -   & 
			-   & -  && -  & - & - &  -\\
			&$(2,4)$ & 304 & 1,209 & 1,203 & 2&& 49 & 325 & 455 & 30 && 65 & 
			436 
			& 613 & 30\\
			&$(2,5)$ & 304 & 1,213 & 1,209 & 2&& -  & -   & -   & -  && -  & - 
			& 
			- & -\\
			&$(3,5)$ & 304 & 1,212 & 1,207 & 2&& 32 & 181 & 233 & 30 && - & - & 
			- 
			& -\\
			\midrule
			\multirow{2}*{WLSIT}&$(2,3)$ & 304 & 1,209 & 1,205 & 2&& - & - & - 
			& 
			- && - & - & - & -\\
			&$(2,4)$ & 304 & 1,211 & 1,207 & 2&& - & - & - & - && - & - & - & 
			-\\
			&$(2,5)$ & 304 & 1,210 & 1,203 & 2&& - & - & - & - && -& - & - & -\\
			&$(3,5)$ & 304 & 1,211 & 1,205 & 2&& 32 & 153 & 177 & 4  && 32 & 
			153 
			& 177 &  4\\
			\midrule%\addlinespace[3pt]
			\acrshort{ab2}                 &   -    & 304 & 1,200 & 1,189 & 2&& 
			32 & 145 & 
			167 & 4&& 32 & 145 & 167 &  4\\
			%\midrule%\addlinespace[3pt]
			\acrshort{ab3}                 &   -    & 304 & 1,086 & 961 & 2 && 
			32 & 143 & 
			163 & 4&& 32 & 143 & 163 &  4\\
			\bottomrule\bottomrule[0.5pt]
		\end{tabular}
...
\begin{table}
	...
	\noindent\makebox[\textwidth]{
		\begin{tabular}{@ {}lcccccccccccc@ {}}\toprule\toprule
			...
			1,196 & 26\\
			\midrule%\addlinespace[3pt]
			\multirow{4}*{WLSE}&$(2,3)$& - & 1,165 & 4,920 & 2,592  & 30 && - & 
			- 
			& - & - & -\\
			&$(2,4)$& * & - & - & -  & -  && 0.40 & 291 & 1,337 & 756 & 24\\
			&$(2,5)$& 1.00 & 554 & 2,378 & 1,270  & 12  && 0.30 & 189 & 942 & 
			564 
			& 28\\
			&$(3,5)$& 0.20 & 472 & 2,042 & 1,098  & 20  && 1.00 & 289 & 1,363 & 
			785 & 26\\
			\midrule%\addlinespace[3pt]
			\multirow{4}*{WLST}&$(2,3)$& - & - & - & - & - && -   & 576 & 2,761 
			& 1,611& 26\\
			&$(2,4)$& 0.50 & 598 & 2,521 & 1,326 & 14 && 0.65 & 326 & 1,585 & 
			934 
			& 29\\
			&$(2,5)$& 0.80 & 608 & 2,591 & 1,375 & 13 && 0.95 & 297 & 1,460 & 
			866 
			& 26\\
			&$(3,5)$& 0.40 & 625 & 2,739 & 1,489 & 21 && 0.90 & 305 & 1,458 & 
			848 
			& 30\\
			\midrule
			\multirow{2}*{WLSIT}&$(2,3)$& - & - & - & - & - && - & - & - & - & 
			- \\
			&$(2,4)$& 0.05 & 592 & 2,507 & 1,324  & 10 && 0.35 & 294 & 1,402 & 
			815 
			& 24 \\
			&$(2,5)$& 1.00 & 601 & 2,564 & 1,362 & 9 && 0.80 & 302 & 1,447 & 
			843 & 
			22 \\
			&$(3,5)$& * & - & - & - & - && * & - & - & - & -\\
			\midrule%\addlinespace[3pt]
			\acrshort{ab2}                & - & - & 758 & 3,156 & 1,643 & 11 && 
			- 
			& 337 & 
			1,546 & 875 & 12\\
			%\midrule%\addlinespace[3pt]
			\acrshort{ab3}                 & - & - & 651 & 2,788 & 1,489 & 18 
			&& 
			- & - & - & 
			- & -\\
			\bottomrule\bottomrule[0.5pt]
...
%	\qquad
%	
%\subfloat[][]{{\includegraphics[width=7.5cm]{FIG46_B.pdf}}\label{fig:FIG46_B}}%
